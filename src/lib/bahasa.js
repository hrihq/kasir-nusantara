...
const EN = {
  ...
  Pindai: 'Scan',
  'Stok habis — tidak bisa dipesan.': 'Out of stock — cannot be ordered.',
  'Stok tinggal %s': 'Only %s left in stock',
  'Pindai barcode untuk isi otomatis.': 'Scan barcode to auto-fill.',
  'Mulai Scan NFC': 'Start NFC Scan',
  'Mencari kartu NFC…': 'Searching for NFC card…',
  'Dekatkan kartu ke belakang HP': 'Hold card near the back of your phone',
